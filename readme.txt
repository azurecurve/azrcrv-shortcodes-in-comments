 ...
 * Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/azrcrv-shortcodes-in-comments/releases/latest/).
...
### [Version 1.2.6](https://github.com/azurecurve/azrcrv-shortcodes-in-comments/releases/tag/v1.2.6)
 * Update plugin header and readme yet again for compatibility with ClassicPress Directory v2.
 * Fix bug with unset options.

### [Version 1.2.5](https://github.com/azurecurve/azrcrv-shortcodes-in-comments/releases/tag/v1.2.5)
...
### [Version 1.2.2](https://github.com/azurecurve/azrcrv-shortcodes-in-comments/releases/tag/v1.2.2)
