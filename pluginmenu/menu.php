 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_sic')){
	function azrcrv_create_plugin_menu_sic(){
		azrcrv_create_plugin_menu_table_sic();
		azrcrv_populate_plugin_menu_table_sic();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_sic')){
	function azrcrv_populate_plugin_menu_table_sic(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_sic')){
	function azrcrv_create_plugin_menu_table_sic(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
